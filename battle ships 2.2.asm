...
blueExplain db 219, ' is an empty slot', 10, '$'
greenExplain db 219, ' is the slot you just chose', 10, '$'
whiteExplain db 219, ' is a ship part', 10, '$'
redExplain db 219, ' is a slot you shot and hit a ship', 10, '$'
yellowExplain db 219, ' is a slot you shot and did not hit a ship', 10, '$'
